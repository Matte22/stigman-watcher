...
.option('--history-write-interval <ms>', 'Interval in milliseconds for when to periodically sync currently scanned files to disk(`WATCHER_HISTORY_WRITE_INTERVAL`)',  parseIntegerArg,  parseIntegerEnv(pe.WATCHER_HISTORY_WRITE_INTERVAL) ?? 15000)
